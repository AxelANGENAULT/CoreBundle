...
class SilentController extends Controller
{
    ...
    public function _construct() {
        $this->workspace = $this->container->getParameter('workspace').'/enterprises/';
    }
    
    public function indexAction()
    {
        return $this->render('AriiCoreBundle:Silent:index.html.twig');
    }
    ...
    public function toolbarAction()
    {
        ...
        return $this->render('AriiCoreBundle:Silent:toolbar.xml.twig',array(), $response);
    }
    ...
    public function generateAction()
    {
        ...
        $install = file_get_contents( $packages.'/scheduler_install.xml' );
        $Lines = explode("\n",$install);
        $Err = array();
        $New = array();
        foreach ($Lines as $l) {
        ...
        file_put_contents( $workspace.'/scheduler_install.xml', implode("\n",$New) );        
        if (count($Err)>0) {
